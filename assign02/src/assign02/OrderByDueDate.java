...
public class OrderByDueDate<Type> implements Comparator<LibraryBookGeneric<Type>> {
	 ...
	 *
	 * @return positive integer if the first library book's due date is later,
	 *         and a negative integer if the first library book's due date is sooner. Zero if
	 *         both are the same due date.
	 */
	@Override
